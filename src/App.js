...
export const StyledImg = styled.img`
  box-shadow: 0px 2px 11px 2px rgba(0, 0, 0, 0.7);
  border: none;
...
function App() {
  ...
  return (
    <s.Screen>
      ...
      >
        <StyledLogo alt={"logo"} src={"/config/images/logo.png"} href={"https://lazyeyes.site/"}/>
        <s.SpacerSmall />
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          ...
          <s.Container
            ...
            style={{
              ...
              borderRadius: 5,
              border: "none",
              boxShadow: "0px 0px 11px 0px rgba(0,0,0,0.7)",
            }}
          >
            <s.TextTitle
              style={{
        ...
        <s.TextDescription
          ...
          >
            DO NOT MINT FROM ANY OTHER SITE OR YOU WILL BE SCAMMED!
          </s.TextDescription>
          <s.SpacerSmall />
          <s.TextDescription
            style={{
